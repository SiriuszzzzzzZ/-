  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center px-4">
      <div className="text-center space-y-4 max-w-sm">
        ...
        <p className="text-sm text-warm-600">班级页面出了点问题</p>
        ...
        <div className="flex gap-3 justify-center">
          ...
          <Link href="/me" className="px-4 py-2 rounded-xl bg-warm-100 text-warm-600 text-sm hover:bg-warm-200 transition-colors">返回我的</Link>
        </div>
      </div>
    </div>
  );
